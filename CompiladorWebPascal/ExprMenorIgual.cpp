...
ExprMenorIgual::ExprMenorIgual(Expresion* izq,Expresion* der)
{
	SetOpOne(izq);
	SetOpTwo(der);
}
...
ExprMenorIgual::~ExprMenorIgual(void)
{
	delete op1;
	delete op2;
}

Tipo* ExprMenorIgual::validarSemantico()
{
...
Valor* ExprMenorIgual::interpretar()
{
