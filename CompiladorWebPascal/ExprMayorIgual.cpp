...
ExprMayorIgual::ExprMayorIgual(Expresion* izq,Expresion* der)
{
	SetOpOne(izq);
	SetOpTwo(der);
}
...
ExprMayorIgual::~ExprMayorIgual(void)
{
	delete op2;
	delete op1;
}

Tipo* ExprMayorIgual::validarSemantico()
{
...
Valor* ExprMayorIgual::interpretar()
{
