...
Division::Division(Expresion* op1,Expresion* op2)
{
	SetOpOne(op1);
	SetOpTwo(op2);
}
...
Tipo* Division::validarSemantico()
{
	...
	throw SemanticException("Estos tipos no son divisibles");
}

Valor* Division::interpretar()
{
